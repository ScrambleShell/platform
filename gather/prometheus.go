...
func (p *prometheusScraper) Gather(ctx context.Context, target platform.ScraperTarget) (collected MetricsCollection, err error) {
...
func (p *prometheusScraper) parse(r io.Reader, header http.Header, target platform.ScraperTarget) (collected MetricsCollection, err error) {
